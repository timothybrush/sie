...
//!
//! NOTE: This is the adapter-side copy. The sidecar carries an
//! identical implementation at
//! `packages/sie_server_sidecar/src/output/numpy_sentinel.rs`; both
//! must produce byte-for-byte identical output because the gateway
//! / SDK decoders are oblivious to which side framed the bytes.
//!
